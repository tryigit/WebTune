...
| ` #incognito-screenshot ` | **Disabled** | **Low Risk:** Protects your privacy by preventing screenshots within Incognito mode, ensuring sensitive information is not unintentionally captured or leaked. |
